...
const CATEGORY_KEYWORDS: [string, string[]][] = [
  ...
  ["Lazer", ["cinema", "show", "jogo", "game", "passeio", "parque", "festa", "balada", "bar", "beer", "cerveja", "bebida", "ingresso", "hobby", "boliche", "ruina", "shopping", "kartódromo", "kartodromo", "escape room", "zoológico", "zoologico", "museu", "exposição", "exposicao", "festival", "karaoke", "sinuca", "bilhar", "fliperama", "sympla", "eventim"]],
