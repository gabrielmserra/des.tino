...
const CATEGORY_KEYWORDS: [string, string[]][] = [
  ...
  ["Alimentação", ["mercado", "supermercado", "comida", "almoço", "almoco", "janta", "jantar", "lanche", "restaurante", "ifood", "padaria", "açougue", "acougue", "feira", "café", "cafe", "pizza", "hambúrguer", "hamburguer", "burguer", "sorvete", "doce", "rappi", "todeschini", "blumenauense", "casa luce", "grsa volvo", "massas", "espetinhos", "espaco soccer", "esfiha", "esfirra", "temaki", "sushi", "yakisoba", "churrasco", "grelhados", "quitanda", "food truck", "foodtruck", "açaí", "acai", "acaiteria", "cantina", "pizza hut", "dominos", "mc donald", "mcdonald", "burger king", "bob's", "bobs", "habib's", "habibs", "subway", "giraffas", "spoleto", "china in box", "outback", "madero", "coco bambu", "kfc", "popeyes", "starbucks", "cacau show", "kopenhagen", "gelateria", "tapiocaria", "creperia", "hamburgueria", "pastelaria", "pastel", "coxinha", "carrefour", "atacadão", "atacadao", "assaí", "assai", "extra", "pão de açúcar", "pao de acucar", "angeloni", "condor", "zaffari", "muffato"]],
  ["Transporte", ["uber", "99", "gasolina", "combustível", "combustivel", "álcool", "alcool", "ônibus", "onibus", "metrô", "metro", "estacionamento", "pedágio", "pedagio", "passagem", "mecânico", "mecanico", "oficina", "brt", "bilhete", "etanol", "cabify", "indriver", "localiza", "movida", "unidas", "ipva", "despachante", "pneu", "lava jato", "lavajato", "funilaria"]],
  ...
  ["Lazer", ["cinema", "show", "jogo", "game", "passeio", "parque", "festa", "balada", "bar", "cerveja", "bebida", "ingresso", "hobby", "boliche", "ruina", "shopping", "kartódromo", "kartodromo", "escape room", "zoológico", "zoologico", "museu", "exposição", "exposicao", "festival", "karaoke", "sinuca", "bilhar", "fliperama", "sympla", "eventim"]],
