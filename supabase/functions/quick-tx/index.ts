...
const CATEGORY_KEYWORDS: [string, string[]][] = [
  ...
  ["Alimentação", ["mercado", "supermercado", "comida", "almoço", "almoco", "janta", "jantar", "lanche", "restaurante", "ifood", "padaria", "açougue", "acougue", "feira", "café", "cafe", "pizza", "hambúrguer", "hamburguer", "burguer", "sorvete", "doce", "rappi"]],
  ...
  ["Lazer", ["cinema", "show", "jogo", "game", "passeio", "parque", "festa", "balada", "bar", "cerveja", "bebida", "ingresso", "hobby", "boliche"]],
  ["Educação", ["curso", "livro", "faculdade", "escola", "mensalidade", "udemy", "alura", "apostila", "material escolar"]],
