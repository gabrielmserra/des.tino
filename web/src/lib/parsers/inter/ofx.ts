...
// OFX 1.x (tags <STMTTRN>/<TRNTYPE>/<DTPOSTED>/<TRNAMT>/<MEMO>).
...
// nesses arquivos. parseOfxTime() continua aqui por completude (outros
// bancos podem mandar hora), mas pro Inter sempre retorna null.
